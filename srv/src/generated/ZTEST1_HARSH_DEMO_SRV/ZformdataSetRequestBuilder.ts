 ...
 */
export class ZformdataSetRequestBuilder<
...
> extends RequestBuilder<ZformdataSet<T>, T> {
  ...
  getAll(): GetAllRequestBuilder<ZformdataSet<T>, T> {
    return new GetAllRequestBuilder<ZformdataSet<T>, T>(this.entityApi);
  }
  ...
  getByKey(
    ...
    return new GetByKeyRequestBuilder<ZformdataSet<T>, T>(this.entityApi, {
      Formid: formid
    });
  }
}
