 ...
 */
export declare class CustomeTileSetRequestBuilder<
...
> extends RequestBuilder<CustomeTileSet<T>, T> {
   ...
   */
  create(entity: CustomeTileSet<T>): CreateRequestBuilder<CustomeTileSet<T>, T>;
  /**
   ...
   */
  update(entity: CustomeTileSet<T>): UpdateRequestBuilder<CustomeTileSet<T>, T>;
}
