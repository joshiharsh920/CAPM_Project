 ...
 */
export declare class ZtestharshDemoRequestBuilder<
...
> extends RequestBuilder<ZtestharshDemo<T>, T> {
   ...
   */
  create(entity: ZtestharshDemo<T>): CreateRequestBuilder<ZtestharshDemo<T>, T>;
  /**
   ...
   */
  update(entity: ZtestharshDemo<T>): UpdateRequestBuilder<ZtestharshDemo<T>, T>;
  /**
